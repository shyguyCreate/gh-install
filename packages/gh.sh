...
package_for_x64="gh_.*_linux_amd64\.tar\.gz"
package_for_arm64="gh_.*_linux_arm64\.tar\.gz"
package_for_arm32="gh_.*_linux_armv6\.tar\.gz"
package_for_x32="gh_.*_linux_386\.tar\.gz"
